...
**随包收录 10 位成员、68 个别名和 10 张已绑定的角色参考图。** 本项目是供 Agent 读取的技能与素材包，生成图片需要运行环境提供生图工具。
...
<table>
  ...
  <tr>
    <td align="center"><img src="assets/characters/li-jianyu/黎健毓.jpg" width="220" alt="黎健毓的角色参考：蓝白机器猫、黑色卷发、银框眼镜和金色铃铛"><br><strong>黎健毓</strong><br><sub>蓝白机器猫 · 黑卷发 · 银框眼镜</sub></td>
  </tr>
</table>
...
| 罗宇伦 | 企鹅、扑克、朴客、撸一撸、录一录 |
| 彭鹏 | 彭鸟、鸟鸟、鸟别 |
| 唐博釜 | 唐伯虎、唐白虎、虎先锋 |
| 唐胤鑫 | 唐狗、tango、帅狗、狗别 |
| 涂腾辉 | 涂涂、鹿、鹿腾辉、兔爷、兔兔、涂爷、涂别 |
| 魏子奇 | 拍别、魏别、维基吧、重庆别、青蛙、蛙别、鹿子奇、五子棋 |
| 夏炜城 | 龟龟、龟炜城、夏别、龟别、龟头 |
| 詹绍源 | 鹿绍源、困困、水豚、困别、战绩吧、詹味、展位、水豚噜噜 |
| 黎健毓 | 寝委书记、书记、记记、记吧、黎书记、哆啦A梦、哆啦B梦、B梦、健叔 |
...
| 你可以这样说 | 技能应如何理解 |
| --- | --- |
| 书记、健叔和 B梦一起吃饭 | 同为黎健毓，只出现一个角色 |
| 毛毛、臻哥还有企鹅去吃宵夜 | 李彦臻、罗宇伦，共两位 |
| 鹿子奇、鹿绍源和鹿去露营 | 魏子奇、詹绍源、涂腾辉，共三位 |
| 青蛙和企鹅下五子棋 | 两位成员下棋，不增加第三个角色 |
| 全员吃火锅，除了狗别 | 十人名单中排除唐胤鑫，共九位 |
| 鸟鸟给龟龟拍一张 | 夏炜城入镜，彭鹏为拍摄者 |
| 不是企鹅，是鸟别，其他不变 | 替换为彭鹏，保留其余条件 |
| 还是刚才那三个人，换成海边 | 沿用已确认的名单，修改场景 |

“展位”“扑克”“录一录”“五子棋”“记吧”等词既可能是昵称，也可能是普通词语。例如“在展位打扑克，录一录视频”不应仅因命中词语就添加成员；“叫上展位、录一录和五子棋”则提供了召集人物的语境。发生影响出场名单的歧义时，技能要求先澄清。
...
2026-09-24 的本地静态检查确认：人物数为 10、别名数为 68，本名与别名没有跨人物重复，十张参考图均存在且 SHA-256 与档案一致。具体范围见 [静态检查记录](docs/verification.json)，README 的重要声明对应关系见 [文档证据记录](docs/readme-evidence.json)。
...
本项目采用 [MIT 许可证](LICENSE)，版权所有 © 2026 Roylyl。
